  ...
  return (
    <Layout>
      ...
      <div
        ...
        style={{ backgroundImage: `url('/public/lovable-uploads/080cd85e-7544-4e3a-98a9-178087f36beb.png')` }}
      >
      ...
      <div className="py-12">
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto">
            ...
            <div className="bg-white p-6 rounded-lg shadow-md mb-6">
              <h3 className="text-xl font-bold mb-3">Reservation Information</h3>
            ...
            <div className="bg-white p-6 rounded-lg shadow-md">
              <h3 className="text-xl font-bold mb-3">Rules & Guidelines</h3>
              <p className="text-gray-600 mb-4">
