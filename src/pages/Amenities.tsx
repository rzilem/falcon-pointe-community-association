      ...
      <div className="py-12 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="text-center mb-8">
            <ContentDisplay section="amenities-description" fallbackTitle="World-Class Amenities" fallbackContent={<p className="text-gray-600 max-w-3xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {amenities.map((amenity, index) => <Card key={index} className="overflow-hidden hover:shadow-lg transition-shadow">
                <div className="h-48 overflow-hidden">
                  <ImageDisplay location={amenity.location} fallbackSrc={amenity.image} alt={amenity.title} className="w-full h-full object-cover hover:scale-105 transition-transform duration-500" />
                </div>
      ...
      <div className="py-12">
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto">
            ...
            <div className="bg-white p-6 rounded-lg shadow-md mb-6">
              <ContentDisplay section="amenities-reservations" fallbackTitle="Reservation Information" fallbackContent={<>
            ...
            <div className="bg-white p-6 rounded-lg shadow-md">
              <ContentDisplay section="amenities-rules" fallbackTitle="Rules & Guidelines" fallbackContent={<>
                    <p className="text-gray-600 mb-4">
