...
const Reservations = () => {
  return <Layout>
      ...
      <div className="relative h-[250px] bg-cover bg-center">
        <ImageDisplay location="reservations-banner" fallbackSrc="/lovable-uploads/ebafe490-e728-4ed8-a428-ff945cb1df98.png" alt="Reservations Banner" className="absolute inset-0 w-full h-full object-cover" />
      ...
      <div className="py-12 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto mb-8">
            <ContentDisplay section="reservations-info" fallbackTitle="Reserve Our Community Spaces" fallbackContent={<p className="text-gray-600">
          ...
          <div className="max-w-5xl mx-auto">
                ...
                <Card>
                  ...
                  <CardContent>
                    <div className="grid md:grid-cols-2 gap-6 mb-6">
                      <div>
                        <ImageDisplay location="pool-pavilion" fallbackSrc="/lovable-uploads/ebafe490-e728-4ed8-a428-ff945cb1df98.png" alt="Pool Pavilion" className="w-full h-64 object-cover rounded-lg mb-4" />
                        <ContentDisplay section="pool-pavilion-info" fallbackContent={<div className="space-y-4">
                      ...
                      <div className="h-[700px]">
                        <div className="calendly-inline-widget" data-url="https://calendly.com/falconpointe/pool-pavilion?hide_gdpr_banner=1" style={{
                        minWidth: "320px",
                        height: "700px"
                      }}></div>
                      </div>
              ...
              <TabsContent value="event-room" className="mt-6">
                <Card>
                  ...
                  <CardContent>
                    <div className="grid md:grid-cols-2 gap-6 mb-6">
                      <div>
                        <ImageDisplay location="event-room" fallbackSrc="https://ufhcicqixojqpyykjljw.supabase.co/storage/v1/object/public/site-images//OH%20yeah.jpg" alt="Indoor Event Room" className="w-full h-64 object-cover rounded-lg mb-4" />
                        <ContentDisplay section="event-room-info" fallbackContent={<div className="space-y-4">
                      ...
                      <div className="h-[700px]">
                        <div className="calendly-inline-widget" data-url="https://calendly.com/falconpointe/30min?hide_gdpr_banner=1" style={{
                        minWidth: "320px",
                        height: "700px"
                      }}></div>
                      </div>
            ...
            <div className="mt-8 bg-white p-6 rounded-lg shadow-sm">
              ...
              <ContentDisplay section="reservation-guidelines" fallbackContent={<ul className="list-disc pl-5 space-y-2 text-gray-600">
